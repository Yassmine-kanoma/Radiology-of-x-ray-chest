...
class CornScreen extends StatefulWidget {
  ...
  @override
  _CornScreenState createState() => _CornScreenState();
}
...
class _CornScreenState extends State<CornScreen> {
  ...
  Future<void> loadModel() async {
    await Tflite.loadModel(
      model: 'assets/package/model_unquant.tflite',
      labels: 'assets/package/labels.txt',
    );
    setState(() {
      _loading = false;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Corn Disease Detection'),
      ),
      body: _loading
